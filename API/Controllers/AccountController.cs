...
public class AccountController(UserManager<AppUser> userManager, ITokenSerervice tokenSerervice):BaseApiController
{
...
return await user.ToDto(tokenSerervice);
...
var refreshToken = tokenSerervice.GenerateRefreshToken();
